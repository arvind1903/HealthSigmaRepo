package com.pos.hs.model;

import java.util.List;

import com.pos.services.util.SecurityUtils;
...
public class UserModel {
	...
	public boolean matchesPassword( String userPassword ) throws Exception
	{
		String hashedPassword = SecurityUtils.sha1(userPassword + getSaltPassword());
		
		return hashedPassword.equals(getHashPassword());
